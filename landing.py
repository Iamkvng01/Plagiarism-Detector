...
LOGO_IMAGE = "Images/pladaainew.png"
img = Image.open('Images/pladaainew.png')
st.set_page_config(
    page_title='PladaAI',
    page_icon=img,
    layout="wide",
...
with col1:
    image = Image.open('Images/pladaainew.png')
    st.markdown(
        """
        <style>
        .big-font {{
...
with col2:
    ...
    st.link_button('Get Started', 'http://localhost:8502/', use_container_width=True)

# Footer
link = Image.open('Images/linked.png')
